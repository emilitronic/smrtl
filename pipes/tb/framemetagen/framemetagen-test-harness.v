//========================================================================
// PIPE Framemetagen Test Harness pipes/tb/framemetagen/framemetagen-test-harness.v
//========================================================================
...
module TestHarness#(
  ...
  `ASIC_IMPL#(
    ...
    .p_frame_id_nbits ( `ASIC_FRAME_ID_NBITS  ),
    .p_beat_idx_nbits ( `ASIC_BEAT_IDX_NBITS  ),
    .p_data_nbits     ( `ASIC_DATA_NBITS      ),
