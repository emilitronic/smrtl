...
This directory is reserved for simple scalar-pipe variants.  The intent is to preserve a known-good baseline while new designs are explored in `rtl/framed/`.
